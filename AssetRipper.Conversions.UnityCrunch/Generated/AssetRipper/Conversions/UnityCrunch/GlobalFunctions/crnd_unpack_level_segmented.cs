...
internal static partial class crnd_unpack_level_segmented
{
	...
	public unsafe static bool Invoke(void* pContext, void* pSrc, int src_size_in_bytes, void* pDst, int dst_size_in_bytes, int row_pitch_in_bytes, int level_index)
	{
		...
		startFrame.GetLocalsPointer<LocalVariables>()->field_7 = null;
		...
		startFrame.GetLocalsPointer<LocalVariables>()->field_5 = src_size_in_bytes;
		startFrame.GetLocalsPointer<LocalVariables>()->field_6 = pSrc;
		startFrame.GetLocalsPointer<LocalVariables>()->field_7 = pContext;
		if (unchecked(startFrame.GetLocalsPointer<LocalVariables>()->field_7 == null || startFrame.GetLocalsPointer<LocalVariables>()->field_6 == null || startFrame.GetLocalsPointer<LocalVariables>()->field_4 == null || (uint)startFrame.GetLocalsPointer<LocalVariables>()->field_3 < 8u || (uint)startFrame.GetLocalsPointer<LocalVariables>()->field_1 >= 16u))
		{
			startFrame.GetLocalsPointer<LocalVariables>()->field_0 = false;
		}
		else
		{
			void* field_ = startFrame.GetLocalsPointer<LocalVariables>()->field_7;
			startFrame.GetLocalsPointer<LocalVariables>()->field_8 = field_;
			if (!is_valid.Invoke(startFrame.GetLocalsPointer<LocalVariables>()->field_8))
			{
				startFrame.GetLocalsPointer<LocalVariables>()->field_0 = false;
			}
			else
			{
				bool field_2 = unpack_level_zjb72ec.Invoke(startFrame.GetLocalsPointer<LocalVariables>()->field_8, level_index: startFrame.GetLocalsPointer<LocalVariables>()->field_1, row_pitch_in_bytes: startFrame.GetLocalsPointer<LocalVariables>()->field_2, dst_size_in_bytes: startFrame.GetLocalsPointer<LocalVariables>()->field_3, pDst: startFrame.GetLocalsPointer<LocalVariables>()->field_4, src_size_in_bytes: startFrame.GetLocalsPointer<LocalVariables>()->field_5, pSrc: startFrame.GetLocalsPointer<LocalVariables>()->field_6);
