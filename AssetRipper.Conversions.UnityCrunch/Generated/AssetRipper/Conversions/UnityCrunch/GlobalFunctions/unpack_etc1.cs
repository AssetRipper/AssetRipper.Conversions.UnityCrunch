...
internal static partial class unpack_etc1
{
	...
	public unsafe static bool Invoke(void* @this, [NativeType("unsigned char **")] void* pDst, [NativeType("unsigned int")] int output_pitch_in_bytes, [NativeType("unsigned int")] int output_width, [NativeType("unsigned int")] int output_height)
	{
		...
		unchecked
		{
			...
			if ((uint)size_yykac7.Invoke(&((crnd_crn_unpacker*)@this)->m_block_buffer) < (uint)(num2 << 1))
			{
				resize_2tt9kz.Invoke(&((crnd_crn_unpacker*)@this)->m_block_buffer, num2 << 1);
			...
			for (int i = 0; (uint)i < (uint)crn_packed_uint_1_ToUInt32.Invoke(&((crnd_crn_header*)((crnd_crn_unpacker*)@this)->m_pHeader)->m_faces); i++)
			{
				...
				while ((uint)num7 < (uint)num3)
				{
					...
					while ((uint)num8 < (uint)num2)
					{
						...
						void* ptr2 = vector_struct_crnd_crn_unpacker_block_buffer_element_Operator.Invoke(&((crnd_crn_unpacker*)@this)->m_block_buffer, num8 << 1);
						sbyte b2;
						if ((num7 & 1) != 0)
						{
						...
						b2 = (sbyte)((byte)b2 >> 2);
						int num10 = *(int*)vector_unsigned_int_Operator.Invoke(&((crnd_crn_unpacker*)@this)->m_color_endpoints, num5);
						*(int*)(&localsPointer->field_1) = num10;
						...
						num6 = (ushort)((crnd_crn_unpacker_block_buffer_element*)vector_struct_crnd_crn_unpacker_block_buffer_element_Operator.Invoke(&((crnd_crn_unpacker*)@this)->m_block_buffer, (num8 << 1) | 1))->color_endpoint_index;
						((crnd_crn_unpacker_block_buffer_element*)vector_struct_crnd_crn_unpacker_block_buffer_element_Operator.Invoke(&((crnd_crn_unpacker*)@this)->m_block_buffer, (num8 << 1) | 1))->color_endpoint_index = (short)num5;
						int num12 = *(int*)vector_unsigned_int_Operator.Invoke(&((crnd_crn_unpacker*)@this)->m_color_endpoints, num5);
						*(int*)(&localsPointer->field_2) = num12;
						if ((b & 1) == 1)
						{
							...
							*(int*)ptr = *(int*)(&localsPointer->field_0);
							((int*)ptr)[1] = *(int*)vector_unsigned_int_Operator.Invoke(&((crnd_crn_unpacker*)@this)->m_color_selectors, (num11 << 1) | num13);
						}
						num8++;
						ptr = (byte*)ptr + 8;
					}
