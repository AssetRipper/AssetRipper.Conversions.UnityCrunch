			...
			else
			{
				...
				for (int k = 0; (uint)k < (uint)num_syms; k++)
				{
					...
					if (num9 != 0)
					{
						...
						{
							crnd_assert.Invoke(String_ez6imn.__pointer, String_vvx8bt.__pointer, 1796);
						}
						int num10 = ((int*)(&localsPointer->field_2))[(uint)num9]++;
						if ((uint)num10 >= (uint)num4)
						{
							crnd_assert.Invoke(String_zzatd6.__pointer, String_vvx8bt.__pointer, 1800);
						}
				...
				if (num != 0)
				{
					...
					for (int l = 1; (uint)l <= (uint)num; l++)
					{
						...
						for (int m = num14; (uint)m <= (uint)num15; m++)
						{
							...
							{
								crnd_assert.Invoke(String_7anbbg.__pointer, String_vvx8bt.__pointer, 1838);
							}
							for (int n = 0; (uint)n < (uint)num13; n++)
							{
								...
								{
									crnd_assert.Invoke(String_g3mv3q.__pointer, String_vvx8bt.__pointer, 1843);
								}
								if (((int*)((crnd_prefix_coding_decoder_tables*)@this)->m_lookup)[(uint)num18] != -1)
								{
									crnd_assert.Invoke(String_5k7f4m.__pointer, String_vvx8bt.__pointer, 1845);
								}
