	...
	public unsafe static bool Invoke(void* @this)
	{
		...
		unchecked
		{
			...
			if (ExceptionInfo.Current == null)
			{
				...
				if (ExceptionInfo.Current == null)
				{
					resize_9ubjj8.Invoke(alpha_selectors, num * 3);
					if (ExceptionInfo.Current == null)
					{
						...
						while (true)
						{
							if ((uint)num4 < (uint)size_g72hpe.Invoke(&((crnd_crn_unpacker*)@this)->m_alpha_selectors))
							{
								int num5 = 0;
								int num6 = 0;
								...
								void* ptr = vector_unsigned_short_Operator.Invoke(&((crnd_crn_unpacker*)@this)->m_alpha_selectors, num4++);
								if (ExceptionInfo.Current != null)
								{
									break;
								}
								*(short*)ptr = num9;
								...
								void* ptr2 = vector_unsigned_short_Operator.Invoke(&((crnd_crn_unpacker*)@this)->m_alpha_selectors, num4++);
								if (ExceptionInfo.Current != null)
								{
									break;
								}
								*(short*)ptr2 = num10;
								...
								void* ptr3 = vector_unsigned_short_Operator.Invoke(&((crnd_crn_unpacker*)@this)->m_alpha_selectors, num4++);
								if (ExceptionInfo.Current != null)
								{
									break;
								}
